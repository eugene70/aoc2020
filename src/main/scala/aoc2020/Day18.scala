...
object Day18:
  ...
  enum Op:
    case Addition, Multiplication, Parenthesis

  class ExpItem

  class Exp

  @main def runDay18: Unit =
    val testData = time("testReady", () => ready(testInput))
    time("tesPart1", () => part1(testData)) // shuld be 13658
...
//    time("part2", () => part2(data))
  ...
  private def part1(data: InputType): BigInt = {
    data
      .map(calc)
    0
  }
